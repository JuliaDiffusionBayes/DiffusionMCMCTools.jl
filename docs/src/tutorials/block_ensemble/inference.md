...
```
![inference_data](../../assets/tutorials/block_ensemble/inference_data.png)
...
plot(getindex.(θθ, 1))
```
![inference_chain](../../assets/tutorials/block_ensemble/inference_chain.png)
...
```
![inference_smoothed_paths](../../assets/tutorials/block_ensemble/inference_smoothed_paths.png)
